...
for entry in lea_data:
    html_content = """
    <div style="border: 1px solid #ddd; border-radius: 12px; padding: 10px; margin: 10px;">
        <h2>{}</h2>
...
viewof fe_rows = Inputs.table(lea_search, {
  ...
  format: {
    'lea_name': x => htl.html`<button type="button" style="border-radius: 12px;" class="options">${x}</button>`,
  },
  align: {
    lea_name: "center",
  },
...
<script>
    ...
    // select element 
    let lea_buttons = document.querySelectorAll('.options');
