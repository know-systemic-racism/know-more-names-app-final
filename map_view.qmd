...
viewof race = Inputs.checkbox(
  ["African American", "Latine", "European-American/White", "Asian/Pacific Islander", "Native American/Alaskan", "Race Unspecified"],
  {
    ...
    "value": ["African American", "Latine", "European-American/White", "Asian/Pacific Islander", "Native American/Alaskan", "Race Unspecified"],
  }
)
```
```{python}
...
filtered = combineDf.filter(function(person) {
